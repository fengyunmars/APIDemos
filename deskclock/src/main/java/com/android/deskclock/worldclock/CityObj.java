...
public class CityObj {
    ...
    private static final String CITY_PINYIN = "city_pinyin_";
    ...
    public CityObj(String name, String timezone, String id, String index, String pinyin) {
        mCityName = name;
        mTimeZone = timezone;
        mCityId = id;
        mCityIndex = index;
    ...
    public CityObj(SharedPreferences prefs, int index) {
        ...
        mPinYin = prefs.getString(CITY_PINYIN + index, null);
    }
    ...
    public void saveCityToSharedPrefs(SharedPreferences.Editor editor, int index) {
        ...
        editor.putString(CITY_PINYIN + index, mPinYin);
    }
}
