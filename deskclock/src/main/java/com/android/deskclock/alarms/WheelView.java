...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	private void initData(Context context) {
        ...
        int height = (int) context.getResources().getDimension(R.dimen.day_select_wheel_height);
...
//		ITEMS_TEXT_COLOR;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int topHeight = (int) getResources().getDimension(R.dimen.day_select_top_height) + 1;
