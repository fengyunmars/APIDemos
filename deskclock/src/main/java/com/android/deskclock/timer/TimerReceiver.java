...
//            showInUseNotification(context);
    ...
    //     cancelTimesUpNotification(context, t); 
         /*fengyun-Cancel status bar notification-lixing-205-6-10-end*/
            ...
            timersAlert.putExtra("length", t.mOriginalLength);
...
//                showTimesUpNotification(context, t);    /*fengyun-Do not show notification bar-lixing-2015-6-15*/
    ...
    private void updateNextTimesup(Context context) {
        ...
        Log.d("TimerReceiver","nextTimesup is:" + nextTimesup);
    ...
    private void showInUseNotification(final Context context) {
        ...
        LogUtils.d(TAG, "showInUseNotification: timer size is %d", timersInUse.size());
    ...
    private void showCollapsedNotificationWithNext(
        ...
        LogUtils.d(TAG, "showCollapsedNotificationWithNext nextBroadcastTime: %d",
                nextBroadcastTime);
    ...
    private static void showCollapsedNotification(final Context context, String title, String text,
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setLocalOnly(true);
        LogUtils.d(TAG, "showCollapsedNotification title: %s, text: %s, notificationId %d ", title,
                text, notificationId);
        if (showTicker) {
    ...
    /**
     * Method Description: send a broadcast to the Timer Fragment
     * @author lixing
     * @return void
     * time : 2015-5-25
     * @param context
