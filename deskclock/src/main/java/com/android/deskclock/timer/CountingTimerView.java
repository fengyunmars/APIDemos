...
public class CountingTimerView extends View {
    ...
    public CountingTimerView(Context context, AttributeSet attrs) {
        ...
        if(isOrignal){
        	 ...
        	 mBigFontSize = r.getDimension(R.dimen.small_font_size);
             mSmallFontSize = r.getDimension(R.dimen.label_font_size);
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mMinutes != null) {
            ...
            xTextStart = mBigMinutes.draw(canvas,mmm, xTextStart, yTextStart);
        }
        if (mSeconds != null) {
        	String sss=":"+mSeconds;
        	if(mMinutes==null){
            ...
            xTextStart = mBigSeconds.draw(canvas, sss, xTextStart, yTextStart);
        }
        if (mHundredths != null) {
