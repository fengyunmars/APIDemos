...
public class RingerVolumePreference extends VolumePreference {
    ...
    private String mActiveProfileKey;// ddd alarm
    public RingerVolumePreference(Context context, AttributeSet attrs) {
        ...
        Log.d(TAG,"mStreamType is:" + mStreamType + ", AudioManager.STREAM_ALARM is:" + AudioManager.STREAM_ALARM);  ///add by lixing
        a.recycle();
    }
...
//          mOriginalStreamVolume = mAudioManager.getStreamVolume(mStreamType);// ddd alarm   
            ...
            Log.d(TAG, "initSeekBar mOriginalStreamVolume_mProfileManager = " + mOriginalStreamVolume);
