...
public class fengyunAlarmClockFragment extends DeskClockFragment
	...
	private AlarmItemAdapter mAdapter;
	 fengyun-添加新的闹钟item适配器对象变量- fengyun-2015-4-8-start
	private NewBaseItemAdapter mNewAdapter;
	 fengyun-添加新的闹钟item适配器对象变量- fengyun-2015-4-8-end
	private View mEmptyView;
	private View mFooterView;

	 fengyun-添加闹钟Button对象变量- fengyun-2015-4-8-start
	private Button addAlarm;
	 fengyun-添加闹钟Button对象变量- fengyun-2015-4-8-end

	 fengyun-设置Button对象变量- fengyun-2015-4-13-start
	private Button alarm_set;
	 fengyun-设置Button对象变量- fengyun-2015-4-13-end
	...
	private Transition mEmptyViewTransition;
	 fengyun-添加闹钟List器对象变量- fengyun-2015-4-8-start
	private List<Alarm> allAlarms;
	 fengyun-添加闹钟List器对象变量- fengyun-2015-4-8-end

	 fengyun-闹钟Layout布局，增加闹钟layout布局-- fengyun-2015-4-22-start
	...
	Button minuteSet;
	Button hourSet;
	 fengyun-闹钟Layout布局，增加闹钟layout布局-- fengyun-2015-4-22-end
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
		...
		// Inflate the layout for this fragment
		 ...
		 fengyun-添加宏开关选择布局文件- fengyun-2015-4-8-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
		 ...
		 fengyun-添加宏开关选择布局文件- fengyun-2015-4-8-end

		 fengyun-添加 增加闹钟布局文件- fengyun-2015-4-22-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
			setAddAlarmView(v);
		}
		 fengyun-添加 增加闹钟布局文件- fengyun-2015-4-22-end

		 fengyun-添加闹钟Button点击事件- fengyun-2015-4-8-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
		 ...
		 fengyun-添加闹钟Button点击事件- fengyun-2015-4-8-end

		 fengyun-设置Button点击事件- fengyun-2015-4-13-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
		 ...
		 fengyun-设置Button点击事件- fengyun-2015-4-13-end
		...
		mAdapter = new AlarmItemAdapter(getActivity(), expandedId, repeatCheckedIds, selectedAlarms, previousDayMap,
				mAlarmsList);
		 fengyun-添加宏开关关闭原生代码- fengyun-2015-4-11-start
		if (!FeatureOption.MTK_DESKCLOCK_NEW_UI) {
		 ...
		 fengyun-添加宏开关关闭原生代码- fengyun-2015-4-11-end

		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
			 fengyun-新的闹钟item适配器对象变量实例化，并获取闹钟集合- fengyun-2015-4-8-start
			allAlarms = getAllAlarms();
			mNewAdapter = new NewBaseItemAdapter(allAlarms, getActivity());
			 fengyun-新的闹钟item适配器对象变量实例化，并获取闹钟集合- fengyun-2015-4-8-end
		}
		...
		if (mRingtoneTitleCache == null) {
		 ...
		 fengyun-添加宏开关，选择相应的适配器- fengyun-2015-4-8-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
			updateList();
		} else {
			mAlarmsList.setAdapter(mAdapter);
		}
		 fengyun-添加宏开关，选择相应的适配器- fengyun-2015-4-8-end
	...
	public void onResume() {
		...
		if (activity.getSelectedTab() == DeskClock.ALARM_TAB_INDEX) {
		 ...
		 fengyun-添加宏开关- fengyun-2015-4-8-start
		if (FeatureOption.MTK_DESKCLOCK_NEW_UI) {
		 ...
		 fengyun-添加宏开关- fengyun-2015-4-8-end
	...
	*//**
	...
	private void showDeleteAlarmConfirmDialog(final Alarm alarm) {
		...
		// window.setWindowAnimations(R.style.deletalarmstyle); //添加动画
		 ...
		 fengyun-删除闹钟- fengyun-2015-5-7-start
		...
		confirm.setOnClickListener(new View.OnClickListener() {
		 ...
		 fengyun-删除闹钟- fengyun-2015-5-7-end
	...
	*//**
	...
	private void updateList() {
		 fengyun-新的闹钟item适配器对象变量实例化，并获取闹钟集合- fengyun-2015-5-6-start
		allAlarms = getAllAlarms();
		mNewAdapter = new NewBaseItemAdapter(allAlarms, getActivity());
		mAlarmsList.setAdapter(mNewAdapter);
		 fengyun-新的闹钟item适配器对象变量实例化，并获取闹钟集合- fengyun-2015-5-6-end
			...
			dayButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View arg0) {
					final boolean isActivated = dayButtons[index].isActivated();
					 fengyun-这句设置闹钟重复的日期，通过移位写入数据- fengyun-2015-4-11-start
					alarm.daysOfWeek.setDaysOfWeek(!isActivated, NEW_DAY_ORDER[index]);
					 fengyun-这句设置闹钟重复的日期，通过移位写入数据- fengyun-2015-4-11-end
					if (!isActivated) {
						turnOnDayOfWeek(index);
					} else {
						turnOffDayOfWeek(index);
