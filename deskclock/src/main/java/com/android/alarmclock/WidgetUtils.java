...
public class WidgetUtils {
     ...
     */
    public static void setTimeFormat(Context context, RemoteViews clock, int amPmFontSize, int clockId) {
        if (clock != null) {
            // Set the best format for 12 hours mode according to the locale
            clock.setCharSequence(clockId, "setFormat12Hour", Utils.get12ModeFormat(context,amPmFontSize));
