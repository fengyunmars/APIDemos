 ...
 * ------------------------ */
    ...
    /** Array for internal storage 内部存储 of elements.
 ...
 * ------------------------ */
    ...
    /** Construct an m-by-n constant matrix.
     @param m    Number of rows.
     @param n    Number of colums.
     @param s    Fill the matrix with this scalar 标量 value.
     */
    ...
    /** Construct a matrix from a one-dimensional packed 包装 array
...
//    }
    ...
    /** Element-by-element multiplication 乘法 , C = A.*B
     @param B    another matrix
     @return     A.*B
     */
