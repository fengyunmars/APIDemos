...
import com.fengyun.http.presenter.zhihu.impl.ZhihuPresenter;
import com.fengyun.model.zhihu.ZhihuDaily;
import com.fengyun.view.adapter.ZhihuAdapter;
...
public class ZhihuFragment extends BaseFragment implements IZhihuFragment{
    ...
    View view = null;
    IZhihuPresenter zhihuPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recycle = (RecyclerView) view.findViewById(R.id.recycle_zhihu);
    ...
    private void initialDate() {
        zhihuPresenter = new ZhihuPresenter(getContext(), this);
        zhihuAdapter = new ZhihuAdapter(getContext(), ((IListAcitivty)getContext()).getDetailAcitivity());
    }
