...
import com.fengyun.model.topnews.NewsBean;
...
public class TopNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ILoadingMore {
    ...
    private Class mTopNewsDescribeActivity;

    public TopNewsAdapter(Context context, Class topNewsDescribeActivity) {
        ...
        mTopNewsDescribeActivity = topNewsDescribeActivity;
    }
    ...
    private void bindViewHolderNormal(final TopNewsViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                holder.textView.setTextColor(Color.GRAY);
                holder.sourceTextview.setTextColor(Color.GRAY);
                startTopNewsActivity(newsBeanItem, holder, mTopNewsDescribeActivity);
    ...
    private void startTopNewsActivity(NewsBean newsBeanItem, RecyclerView.ViewHolder holder, Class clazz) {
