...
public class MeizhiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ILoadingMore {

    private static final int TYPE_LOADING_MORE = -1;
    private static final int TYPE_NOMAL = 1;
    private boolean loadingMore;

    private ArrayList<Meizhi> meiziItems = new ArrayList<>();
    private Context mContext;
    private Class mMeiziPhotoDescribeActivity;

    public MeizhiAdapter(Context context, Class meiziPhotoDescribeActivity) {
        this.mContext = context;
        mMeiziPhotoDescribeActivity = meiziPhotoDescribeActivity;
    }
    ...
    private void bindViewHolderNormal(final MeiziViewHolder holder, final int position) {
        ...
        final Meizhi meizhi = meiziItems.get(holder.getAdapterPosition());

        holder.imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startDescribeActivity(meizhi,holder, mMeiziPhotoDescribeActivity);
            }
        });
    ...
    private void startDescribeActivity(Meizhi meizi,RecyclerView.ViewHolder holder, Class meiziPhotoDescribeActivity){

        Intent intent = new Intent(mContext, meiziPhotoDescribeActivity);
    ...
    public void addItems(ArrayList<Meizhi> list) {
