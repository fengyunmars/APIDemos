...
import com.fengyun.newspaper.presenter.NetEaseArticlePresenter;
import com.fengyun.newspaper.widget.ElasticDragDismissFrameLayout;
import com.fengyun.newspaper.widget.ParallaxScrimageView;
import com.fengyun.newspaper.widget.TranslateYTextView;
 ...
 */
public class NetEaseArticleActivity extends AppCompatActivity implements INetEaseArticleFragment{
    ...
    private NetEaseArticlePresenter mNetEaseArticlePresenter;
    ...
    private RequestListener glideLoadListener = new RequestListener<String, GlideDrawable>() {
        ...
        public boolean onResourceReady(GlideDrawable resource, String model,
            ...
            final int twentyFourDip = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                    24, NetEaseArticleActivity.this.getResources().getDisplayMetrics());
            Palette.from(bitmap)
                    .maximumColorCount(3)
                        ...
                        public void onGenerated(Palette palette) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                mShot.setForeground(ViewUtils.createRipple(palette, 0.3f, 0.6f,
                                        ContextCompat.getColor(NetEaseArticleActivity.this, R.color.mid_grey),
                                        true));
                            }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.describe_netease);
    ...
    protected void initData() {
        ...
        mNetEaseArticlePresenter = new NetEaseArticlePresenter(this);
...
//                    mShot.animate().alpha(1f).setDuration(800L).start();
    ...
    protected void onDestroy() {
        ...
        mNetEaseArticlePresenter.unsubscrible();
        super.onDestroy();
    ...
    private void getData() {
        mNetEaseArticlePresenter.getDescribleMessage(id);
