...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            navigationId = PreferenceManager.getDefaultSharedPreferences(this).getInt(this.getString(R.string.navigation_item),-1);
            if (navigationId != -1) {
...
//                }
                ...
                if (currentMenuItem != item && currentMenuItem != null) {
                    ...
                    editor.putInt(MainActivity.this.getString(R.string.nevigation_item),id);
                    editor.commit();
    ...
    private void animateToolbar() {
        // this is gross  总共的；粗野的 but toolbar doesn't expose it's children to animate them :(
        View t = toolbar.getChildAt(0);
        if (t != null && t instanceof TextView) {
            TextView title = (TextView) t;

            // fade in and space out 隔开 分隔 the title.
            // Animating the letterSpacing performs horribly 可怕地；非常地so
