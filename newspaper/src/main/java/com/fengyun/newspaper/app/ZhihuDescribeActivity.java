...
import com.fengyun.newspaper.presenter.ZhihuStoryPresenter;
 ...
 */
public class ZhihuDescribeActivity extends SwipeBackActivity implements IZhihuStoryFragment {
...
//    ElasticDragDismissFrameLayout mDraggableFrame;
    ...
    private String url;
    private ZhihuStoryPresenter mIZhihuStoryPresenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.describe_zhihu);
    ...
    protected void initData() {
        ...
        mIZhihuStoryPresenter = new ZhihuStoryPresenter(this);
