...
import com.fengyun.newspaper.app.ZhihuDescribeActivity;
...
public class ZhihuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements MainActivity.LoadingMore {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_NORMAL:
                return new ZhihuViewHolder(LayoutInflater.from(mContext).inflate(R.layout.layout_item_zhihu, parent, false));
