package com.fengyun.newspaper.adapter;
...
import com.fengyun.newspaper.app.NetEaseArticleActivity;
import com.fengyun.newspaper.utils.DBUtils;
...
public class NetEaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements MainActivity.LoadingMore {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_NORMAL:
                return new TopNewsViewHolder(LayoutInflater.from(mContext).inflate(R.layout.layout_item_netease, parent, false));
    ...
    private void startTopNewsActivity(NewsBean newsBeanItem, RecyclerView.ViewHolder holder) {
        ...
        Intent intent = new Intent(mContext, NetEaseArticleActivity.class);
