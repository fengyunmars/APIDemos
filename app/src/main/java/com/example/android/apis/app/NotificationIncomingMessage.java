 ...
 */
public class NotificationIncomingMessage extends Activity {
    @Override
...
//BEGIN_INCLUDE(intent_array)
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        // should display.
        intents[3] = new Intent(context, NotificationIncomingMessageView.class);
        intents[3].putExtra(NotificationIncomingMessageView.KEY_FROM, from);
        intents[3].putExtra(NotificationIncomingMessageView.KEY_MESSAGE, msg);
...
//BEGIN_INCLUDE(interstitial_notification)
    ...
    void showInterstitialNotification() {
        ...
        Intent intent = new Intent(this, NotificationIncomingMessageInterstitial.class);
        intent.putExtra(NotificationIncomingMessageView.KEY_FROM, from);
        intent.putExtra(NotificationIncomingMessageView.KEY_MESSAGE, message);
