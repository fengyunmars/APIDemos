...
public class MenuInflateFromXml extends Activity {
    ...
    private static final int sMenuExampleResources[] = {
            R.menu.inflatefromxml_title_only,
            R.menu.inflatefromxml_title_icon,
            R.menu.inflatefromxml_submenu,
            R.menu.inflatefromxml_groups,
            R.menu.inflatefromxml_checkable,
            R.menu.inflatefromxml_shortcuts,
            R.menu.inflatefromxml_order,
            R.menu.inflatefromxml_category_order,
            R.menu.inflatefromxml_visible,
            R.menu.inflatefromxml_disabled
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            default:
                // Don't toast text when a inflatefromxml_submenu is clicked
                if (!item.hasSubMenu()) {
