 ...
 * running in its own process, the {@link ServiceLocal} sample shows a much
...
public class ServiceRemote extends Service {
    ...
    public void onCreate() {
        ...
        // increment.
        Logger.d("ServiceRemote onCreate");
        mHandler.sendEmptyMessage(REPORT_MSG);
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Logger.d("ServiceRemote", "Received start id " + startId + ": " + intent);
    ...
    public IBinder onBind(Intent intent) {
        ...
        // the Intent.
        Logger.d("ServiceRemote" + "onBind:intent " + intent);
    ...
    public static class Controller extends Activity {
        ...
        private OnClickListener mStartListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                // the service.
                startService(new Intent(Controller.this, ServiceRemote.class));
            }
        };
        ...
        private OnClickListener mStopListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                // still bound clients.
                stopService(new Intent(Controller.this, ServiceRemote.class));
            }
        };
    }
    ...
    public static class Binding extends Activity {
        ...
        private ServiceConnection mConnection = new ServiceConnection() {
            public void onServiceConnected(ComponentName className,
                ...
                Logger.d("ServiceRemote,ServiceConnection,onServiceConnected");
        ...
        private OnClickListener mBindListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                // the same interface.
                Intent intent = new Intent(Binding.this, ServiceRemote.class);
...
// END_INCLUDE(calling_a_service)
    ...
    public static class BindingOptions extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mBindIntent = new Intent(this, ServiceRemote.class);
