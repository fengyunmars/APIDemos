 ...
 */
public class ActionBar03Tabs extends Activity {
    @Override
     ...
     * the interactions 互动 between different tabs.
     *
     * NOTE: This is a very simple implementation that does not retain 保持
    ...
    private class TabListener implements ActionBar.TabListener {
        ...
        public void onTabReselected(Tab tab, FragmentTransaction ft) {
            Toast.makeText(ActionBar03Tabs.this, "Reselected!", Toast.LENGTH_SHORT).show();
        }
