 ...
 */
public class NotificationServiceController extends Activity {
    @Override
    ...
    private OnClickListener mStartListener = new OnClickListener() {
        public void onClick(View v) {
            startService(new Intent(NotificationServiceController.this,
    ...
    private OnClickListener mStopListener = new OnClickListener() {
        public void onClick(View v) {
            stopService(new Intent(NotificationServiceController.this,
                    NotificationService.class));
        }
    };
}
