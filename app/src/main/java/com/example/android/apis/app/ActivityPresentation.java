 ...
 * </p><p>
 * See also the {@link ActivityPresentationWithMediaRouter} sample which
 ...
 * </p>
 */
public class ActivityPresentation extends Activity
    ...
    private final class DisplayListAdapter extends ArrayAdapter<Display> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (contents == null || modes.length == 1) {
                ...
                s.setTag(display);
                s.setOnItemSelectedListener(ActivityPresentation.this);
