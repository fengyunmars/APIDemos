 ...
 */
public class ServiceIsolated extends Service {
    /**
     * This is a list of callbacks that have been registered with the
     * service.  Note that this is package scoped (instead of private) so
     * that it can be accessed more efficiently y有效率的 from inner classes.
     */
    ...
    public void onCreate() {
        Log.i("ServiceIsolated", "Creating ServiceIsolated: " + this);
    }

    @Override
    public void onDestroy() {
        Log.i("ServiceIsolated", "Destroying ServiceIsolated: " + this);
    ...
    public void onTaskRemoved(Intent rootIntent) {
        Log.i("ServiceIsolated", "Task removed in " + this + ": " + rootIntent);
        stopSelf();
    }
    ...
    public static class Controller extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            mService1 = new ServiceInfo(this, ServiceIsolated.class, R.id.start1, R.id.stop1,
                    R.id.bind1, R.id.status1);
            mService2 = new ServiceInfo(this, ServiceIsolated2.class, R.id.start2, R.id.stop2,
