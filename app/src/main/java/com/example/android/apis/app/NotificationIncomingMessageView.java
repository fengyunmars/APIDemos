...
/**
 * This activity is run as the click activity for {@link NotificationIncomingMessage}.
 * When it comes up, it also clears the notification, because the "message"
 * has been "read."
 */
public class NotificationIncomingMessageView extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // cancel the notification that we started in NotificationIncomingMessage
