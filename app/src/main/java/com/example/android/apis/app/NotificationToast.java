 ...
 */
public class NotificationToast extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                // the text yourself.
                Toast.makeText(NotificationToast.this, R.string.short_notification_text,
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(NotificationToast.this, R.string.long_notification_text,
