 ...
 */
public class ZhihuArticleActivity extends SwipeBackActivity implements IZhihuArticle{
    ...
    private RequestListener loadListener = new RequestListener<String, GlideDrawable>() {
        ...
        public boolean onResourceReady(GlideDrawable resource, String model,
            ...
            final int twentyFourDip = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                    24, ZhihuArticleActivity.this.getResources().getDisplayMetrics());
            Palette.from(bitmap)
                    .maximumColorCount(3)
                        ...
                        public void onGenerated(Palette palette) {
                            ...
                            if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.LOLLIPOP){
                                ...
                                mShot.setForeground(ViewUtils.createRipple(palette, 0.3f, 0.6f,
                                        ContextCompat.getColor(ZhihuArticleActivity.this, R.color.mid_grey),
                                        true));
                            }
                        }
                    });
