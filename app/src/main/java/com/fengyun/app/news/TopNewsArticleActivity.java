...
import com.fengyun.http.presenter.topnews.impl.TopNewsArticlePresenter;
 ...
 */
public class TopNewsArticleActivity extends AppCompatActivity implements ITopNewsArticleFragment{
    ...
    private ITopNewsArticlePresenter mTopNewsArticlePresenter;
    ...
    private RequestListener glideLoadListener = new RequestListener<String, GlideDrawable>() {
        ...
        public boolean onResourceReady(GlideDrawable resource, String model,
            ...
            final int twentyFourDip = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                    24, TopNewsArticleActivity.this.getResources().getDisplayMetrics());
            Palette.from(bitmap)
                    .maximumColorCount(3)
                        ...
                        public void onGenerated(Palette palette) {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                mShot.setForeground(ViewUtils.createRipple(palette, 0.3f, 0.6f,
                                        ContextCompat.getColor(TopNewsArticleActivity.this, R.color.mid_grey),
                                        true));
                            }
    ...
    protected void initData() {
        ...
        mTopNewsArticlePresenter = new TopNewsArticlePresenter(this);
...
//                    mShot.animate().alpha(1f).setDuration(800L).start();
    ...
    protected void onDestroy() {
        ...
        mTopNewsArticlePresenter.unsubscrible();
        super.onDestroy();
    ...
    private void getData() {
        mTopNewsArticlePresenter.getDescribleMessage(id);
